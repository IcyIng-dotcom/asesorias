...
<body class="bg-white text-slate-900 antialiased">
    ...
    <div class="px-10 py-8 bg-slate-50 dark:bg-slate-900/50 border-b border-gray-100 dark:border-slate-700">
        <h2 class="text-2xl font-extrabold text-slate-800 dark:text-white tracking-tight">Edición de libros</h2>
        <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Completa los campos para modificar los datos del libro.</p>
    </div>
    ...
    <form action="{{ route('libros.modificar') }}" method="POST" class="p-10">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="titulo" id="titulo" placeholder="" value="{{ $libro->titulo }}"
